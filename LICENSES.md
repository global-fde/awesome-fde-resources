...
Original README text, curated descriptions, member profiles, templates, and other documentation created for this repository are licensed under the [Creative Commons Attribution 4.0 International License](LICENSE).

You may share and adapt this material, including commercially, provided that appropriate attribution is given, a link to the license is included, and changes are indicated.

## Scripts — Apache-2.0

Source code under [`scripts/`](scripts/) is licensed under the [Apache License 2.0](LICENSE-CODE).
